...
// 必须与 android/app/src/main/AndroidManifest.xml 里 FileProvider 的
// android:authorities="${applicationId}.provider" 解析结果一致。
// 二改版把 applicationId 改成了 top.mingqiu.lxmusic，所以这里同步改。
export const APP_PROVIDER_NAME = 'top.mingqiu.lxmusic.provider'
